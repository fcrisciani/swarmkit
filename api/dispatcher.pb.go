...
type SessionMessage struct {
	...
	ZoneNeighbors []string `protobuf:"bytes,6,rep,name=ZoneNeighbors" json:"ZoneNeighbors,omitempty"`
}
...
func (m *SessionMessage) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.ZoneNeighbors != nil {
		m.ZoneNeighbors = make([]string, len(o.ZoneNeighbors))
		copy(m.ZoneNeighbors, o.ZoneNeighbors)
	}
...
func (m *SessionMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ZoneNeighbors) > 0 {
		for _, s := range m.ZoneNeighbors {
			dAtA[i] = 0x32
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (this *SessionMessage) String() string {
	...
	s := strings.Join([]string{`&SessionMessage{`,
		...
		`ZoneNeighbors:` + fmt.Sprintf("%v", this.ZoneNeighbors) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SessionMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ZoneNeighbors", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ZoneNeighbors = append(m.ZoneNeighbors, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDispatcher(dAtA[iNdEx:])
...
var fileDescriptorDispatcher = []byte{
	...
	,
}
